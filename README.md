...
This is a fork of Unity ML Agents extended to support 
...
Please visit [the official website](https://neuroailab.github.io/flex-ml-agents/ "FleX ML Agents Website") for a brief introduction into flex-ml-agents. The FleX ML Agents Simulation Environment is part of our code release for [Flexible Neural Representation for Physics Prediction](https://neuroailab.github.io/physics/ "Flexible Neural Representation for Physics Prediction").
