...
namespace NVIDIA.Flex
{
    ...
    public class FlexContainer : ScriptableObject
    {
        ...
        public float solidRest { get { return m_solidRest; } set { m_solidRest = value; } }

        public float fluidRest { get { return m_fluidRest; } set { m_fluidRest = value; } }

		public float collisionDistance { get { return m_collisionDistance; } set { m_collisionDistance = value; } }

        public ComputeBuffer particleBuffer { get { return m_particleBuffer; } }

        public int[] fluidIndices { get { return m_fluidIndices/*.ToArray()*/; } }
